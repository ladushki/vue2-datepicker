...
new Vue({  // eslint-disable-line
  ...
  render (h) {
    const example1 = {
      ...
      'quarter': '<date-picker v-model="value11" lang="en" type="quarter" format="[Q]Q-YY" range confirm=""></date-picker>',
      'year': '<date-picker v-model="value11" lang="en" type="year" format="YYYY" range></date-picker>',
